...
\newprob {Problem 35} True or false for conditional expectations.\hfil\break
...
takes the value $\sum_x \, x Pr\left(X=x| Y = y\right)$ when $Y=y$.  So we have
$E\left(E\left(X | Y\right) | Y \right) = E\left(f\left(Y\right) | Y\right) = f\left(Y\right) = E\left(X | Y\right),$
as claimed.
