...
just compute $1 \ll \left(\nu x - \nu w - 1\right)$ and add that to $w$.
That's actually not a bad way to do it if you precompute and save
$\nu x - 1$, but Knuth gives a different, more mathematical solution
that took me some effort to understand.
