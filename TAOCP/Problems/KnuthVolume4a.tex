...
the right  with $z \oplus \left(z - 1\right)$.  This is the largest $j$ we can
increase.
...
and half with 1s.  So we can step back from $w$ and just 
fill $u$ halfway by doing $v \, \& \, {\bar w} \gg \left(\nu u \gg 1\right)$,
