...
\noindent [p 31] Again, it's helpful to explore the data structures
...
Thus, $W_2 = 1$, $W_{\bar 2} = 2$, $W_3 = 4, 5$, which
we represent using ${\tt LINK} = \{0, 0, 4, 0\}$.  Alternatively,
in the language of the literals we've been using,
$W_4 = 1$, $W_5 = 2$, $W_6 = 4, 5$, with the rest 0.  Note that,
...
{\bf B4} $W_3 \gets 0$ (which it already was), $d \gets 2$.
