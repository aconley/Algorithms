...
leading zeros intrinsic.  Even {\tt MMIX} doesn't have that...
...
is discussed in {\t Hackers Delight} -- the issue is more or less
...
there (obviously)
must be some non-zero bit of $x$.  So $\left(x | h\right) - l$
will have a zero bit somewhere other than the leading position
unless $x = h$.
