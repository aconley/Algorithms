...
\vskip 0.08in [p 224] \noindent {\bf Synthesis in a BDD base}
...
This follows immediately from the ring discussion.  The parity bit
tells us if we want to make a type (a) move (remove or add the ring
