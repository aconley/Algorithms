...
use taocp::sat::{langford, waerden, SatProblem};
use taocp::sat::dpll_alternatives::dpll_claude::solve_via_dpll as solve_via_dpll_claude;
use taocp::sat::dpll_alternatives::dpll_codex::solve_via_dpll_codex;
use taocp::sat::dpll_alternatives::dpll_gemini::solve_via_dpll as solve_via_dpll_gemini;
